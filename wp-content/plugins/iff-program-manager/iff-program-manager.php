...
class IFF_Program_Manager {
    ...
    private function render_edit_modal() {
        ?>
        <style>
            #iff-edit-modal { display: none; position: fixed; z-index: 99999; left: 0; top: 0; width: 100%; height: 100%; overflow: auto; background-color: rgba(0,0,0,0.6); }
            #iff-edit-modal .modal-content { background-color: #fefefe; margin: 5% auto; padding: 20px; border: 1px solid #888; width: 80%; max-width: 600px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.2); }
            #iff-edit-modal .close { color: #aaa; float: right; font-size: 28px; font-weight: bold; cursor: pointer; }
            #iff-edit-modal .close:hover, #iff-edit-modal .close:focus { color: black; text-decoration: none; cursor: pointer; }
        </style>
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" id="iff-edit-form">
                    ...
                    <table class="form-table">
                        <tr><th>Şehir</th><td><input type="text" name="sehir" id="edit_sehir" required></td></tr>
                        <tr><th>Mekan</th><td><input type="text" name="mekan" id="edit_mekan" required></td></tr>
                        <tr><th>Tarih</th><td><input type="date" name="tarih" id="edit_tarih" required></td></tr>
                        <tr><th>Saat</th><td><input type="time" name="saat" id="edit_saat" required></td></tr>
                        <tr><th>Tür</th><td><select name="tur" id="edit_tur"><option value="film">Film</option><option value="etkinlik">Etkinlik</option></select></td></tr>
                        <tr><th>Başlık (Film/Etkinlik Adı)</th><td><textarea name="film_adi" id="edit_film_adi" required rows="3" style="width:100%;"></textarea></td></tr>
                        <tr><th>Süre</th><td><input type="text" name="sure" id="edit_sure"></td></tr>
                        <tr><th>Detay</th><td><textarea name="etkinlik" id="edit_etkinlik" rows="3" style="width:100%;"></textarea></td></tr>
                        <tr><th>Özel</th><td><label><input type="checkbox" name="is_special" id="edit_is_special" value="1"> Bu özel bir gösterimdir</label></td></tr>
                        <tr><th>Gala</th><td><label><input type="checkbox" name="is_gala" id="edit_is_gala" value="1"> Bu bir Gala seansıdır</label></td></tr>
                    </table>
                    <p class="submit">
