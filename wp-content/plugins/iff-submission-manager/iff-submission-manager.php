            ...
            <form method="post" action="options.php">
                ...
                <div class="card" style="max-width: 800px; padding: 20px; margin-top: 20px;">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            <th>Webhook URL</th>
                            <td><input type="url" name="iff_webhook_url"
                                    value="<?php echo esc_attr(get_option('iff_webhook_url')); ?>" class="regular-text"
                                    placeholder="https://webhook.site/..."></td>
                        </tr>
    ...
    public function render_admin_page()
    {
        ...
        <div class="wrap">
            ...
            <div class="card" style="max-width: 100%; margin-top: 20px; border-left: 4px solid #f97316;">
                <p><strong>Bilgi:</strong> Tüm başvurular hem buraya kaydedilir hem de <a
                        href="<?php echo admin_url('admin.php?page=iff-submission-settings'); ?>">ayarlarda</a> tanımlı webhook
                    ve e-posta adresine iletilir.</p>
            </div>
                        ...
                        foreach ($results as $row):
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small
                                        style="color: #666;"><?php echo mb_strimwidth(isset($data['message']) ? $data['message'] : (isset($data['notes']) ? $data['notes'] : ''), 0, 80, '...'); ?></small>
                                </td>
        ...
        <div id="submission-modal"
            style="display:none; position:fixed; z-index:99999; left:0; top:0; width:100%; height:100%; background:rgba(0,0,0,0.6); overflow:auto;">
            <div
                style="background:#fff; margin:5% auto; padding:30px; border-radius:8px; width:90%; max-width:800px; box-shadow:0 10px 25px rgba(0,0,0,0.2); position:relative;">
                <span id="close-modal"
                    style="position:absolute; right:20px; top:15px; font-size:28px; cursor:pointer; color:#999; line-height:1;">&times;</span>
                <h2 style="border-bottom:2px solid #f97316; padding-bottom:10px; margin-bottom:20px; font-size:20px;">Başvuru
                    Detayları</h2>
                <div id="modal-content-inner"
                    style="display:grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap:15px; font-size:13px;">
                    <!-- Dinamik içerik -->
                </div>
