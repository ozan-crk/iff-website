...
$bg_class = $bg_color ? '' : 'bg-white';
$style = $bg_color ? "background-color: {$bg_color};" : "";
?>
<section class="mb-24 <?php echo $bg_class; ?> p-12 border-4 border-red modern-shadow kimin-festivali-block" style="<?php echo esc_attr($style); ?>">
