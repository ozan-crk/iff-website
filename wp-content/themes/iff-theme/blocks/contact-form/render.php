...
$form_description = get_field('form_aciklamasi') ?: 'Sorularınız, önerileriniz veya talepleriniz için aşağıdaki formu kullanabilirsiniz.';
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white p-8 md:p-16 border-4 border-warmgray contact-form-shadow relative overflow-hidden">
            ...
            <div class="relative z-10">
                <div class="mb-12">
                    <h2
                        class="text-4xl md:text-5xl font-heading font-bold uppercase tracking-tighter text-warmgray mb-4">
                ...
                <form action="#" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-2">
                        <label for="name" class="block text-xs font-bold uppercase tracking-widest text-red">Ad
                            Soyad</label>
                    ...
                    <div class="space-y-2">
                        <label for="email"
                            class="block text-xs font-bold uppercase tracking-widest text-red">E-Posta</label>
                    ...
                    <div class="md:col-span-2 space-y-2">
                        <label for="message"
                            class="block text-xs font-bold uppercase tracking-widest text-red">Mesajınız</label>
                ...
                <div id="form-success-<?php echo esc_attr($block['id']); ?>"
                    class="hidden py-20 text-center animate-fade-in">
                    <div
                        class="w-20 h-20 bg-green-500 text-white rounded-full flex items-center justify-center mx-auto mb-6">
